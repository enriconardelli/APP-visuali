note
	description: "Summary description for {VISUALIZZA_DATI_PREVISIONE}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature {NONE} -- Implementation GUI
	...
	build_temperature_widgets
		...
		do
			...
			temperature_label.set_text ("Previsone Temperatura:")
	...
	build_humidity_widgets
		...
		do
			...
			humidity_label.set_text ("Previsione Umidita:")
	...
	build_pressure_widgets
		...
		do
			...
			pressure_label.set_text ("Previsione Pressione:")
